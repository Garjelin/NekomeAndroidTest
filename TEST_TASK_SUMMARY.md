...
> [!CAUTION]
> **Важно**: Перед запуском тестов убедитесь, что в файле `local.properties` указан актуальный путь к Android SDK. Например:
> ```properties
> sdk.dir=/Users/admin/Library/Android/sdk
> ```
> **Убедитесь, что путь соответствует реальному расположению Android SDK на вашем компьютере.**
